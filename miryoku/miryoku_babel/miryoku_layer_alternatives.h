...
&kp SQT,           &kp N4,            &kp N5,            &kp N6,            &kp EQUAL,         U_NA,              &kp LGUI,          &kp LSHFT,         &kp LALT,          &kp LCTRL,          \
...
&kp DQT,           &kp DLLR,          &kp PRCNT,         &kp CARET,         &kp PLUS,          U_NA,              &kp LGUI,          &kp LSHFT,         &kp LALT,          &kp LCTRL,          \
