...
&kp SQT,          &kp NUM_4,         &kp NUM_5,         &kp NUM_6,         &kp EQL,           U_NA,              &kp LGUI,          &kp LSHFT,         &kp LALT,          &kp LCTRL,          \
...
&kp DQT,         &kp DLLR,          &kp PRCT,          &kp CRRT,          &kp PLUS,          U_NA,              &kp LGUI,          &kp LSHFT,         &kp LALT,          &kp LCTRL,          \
