...
#define MIRYOKU_ALTERNATIVES_BASE_QWERTY_GATLEE \
&kp Q,             &kp W,             &kp E,             &kp R,             &kp T,             &kp Y,             &kp U,             &kp I,             &kp O,             &kp P,             \
U_MT(LCTRL, A),    U_MT(LALT, S),     U_MT(LSHFT, D),    U_MT(LGUI, F),     &kp G,             &kp H,             U_MT(LGUI, J),     U_MT(LSHFT, K),    U_MT(LALT, L),     U_MT(LCTRL, COLON),   \
U_LT(U_BUTTON, Z), U_MT(RALT, X),     &kp C,             &kp V,             &kp B,             &kp N,             &kp M,             &kp COMMA,         U_MT(RALT, DOT),   U_LT(U_BUTTON, SLASH),\
U_NP,              U_NP,              U_LT(U_MEDIA, DEL),U_LT(U_NAV, ESC),  U_LT(U_MOUSE, TAB),U_LT(U_FUN, RET),  U_LT(U_SYM, SPC),  U_LT(U_NUM, BSPC),  U_NP,             U_NP
...
U_NP,              U_NP,              U_NA,              U_NA,              U_NA,              &kp RET,           &kp SPC,           &kp BSPC,           U_NP,              U_NP
...
U_BOOT,            &u_to_U_TAP,       &u_to_U_EXTRA,     &u_to_U_BASE,      U_NA,              U_RDO,             U_PST,             U_CPY,             U_CUT,             U_UND,             \
&kp LCTRL,         &kp LALT,          &kp LSHFT,         &kp LGUI,          U_NA,              U_MS_L,            U_MS_D,            U_MS_U,            U_MS_R,            U_NU,              \
...
U_NA,              &kp RALT,          &u_to_U_FUN,       &u_to_U_MEDIA,     U_NA,              &kp C_MUTE,        &kp C_VOL_DN,      &kp C_VOL_UP,      &u_bt_sel_3,       &u_out_tog,        \
...
&kp LBKT,          &kp NUM_1,         &kp NUM_2,         &kp NUM_3,         &kp RBKT,          U_NA,              &u_to_U_BASE,      &u_to_U_EXTRA,     &u_to_U_TAP,       U_BOOT,            \
&kp SEMI,          &kp NUM_4,         &kp NUM_5,         &kp NUM_6,         &kp EQL,           U_NA,              &kp LGUI,          &kp LSHFT,         &kp LALT,          &kp LCTRL,          \
&kp GRAVE,         &kp NUM_7,         &kp NUM_8,         &kp NUM_9,         &kp BSLH,          U_NA,              &u_to_U_NUM,       &u_to_U_NAV,       &kp RALT,          U_NA,              \
...
&kp COLON,         &kp DLLR,          &kp PRCT,          &kp CRRT,          &kp PLUS,          U_NA,              &kp LGUI,          &kp LSHFT,         &kp LALT,          &kp LCTRL,          \
&kp TILDE,         &kp AMPS,          &kp ASTRK,         &kp LPAR,          &kp PIPE,          U_NA,              &u_to_U_SYM,       &u_to_U_MOUSE,     &kp RALT,          U_NA,              \
...
&kp F11,           &kp F4,            &kp F5,            &kp F6,            &kp SLCK,          U_NA,              &kp LGUI,          &kp LSHFT,         &kp LALT,          &kp LCTRL,          \
